...
//Clase diseÃ±ada para administrar los procesos de la Ficha Familiar
public class FichaFamiliar extends Activity implements TabListener {
     ...
     *  NOTA: en la linea: int respuesta = new Enviador().execute(enviado).get(); el ".get()" debería hacer que el thread principal se espere a recibir un resultado del envio antes de continuar
     * */
	...
	public void onTabSelected(Tab tab, FragmentTransaction ft) {
		  ...
		  if (tab.getText().equals(caption1)) {
			  ...
			  executeFragment(new HechosFragment());
			  ...
			  executeFragment( new MapaFragment());
		  }		
	}
